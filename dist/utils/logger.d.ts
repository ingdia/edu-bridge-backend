 ...
 */
export type AuditAction = 'USER_REGISTER' | 'USER_LOGIN' | 'USER_LOGOUT' | 'PASSWORD_RESET' | 'PASSWORD_RESET_REQUESTED' | 'PASSWORD_RESET_COMPLETED' | 'TOKEN_REFRESH' | 'PROFILE_PHOTO_UPLOADED' | 'PROFILE_PHOTO_DELETED' | 'PROFILE_VIEW' | 'PROFILE_UPDATE' | 'MENTOR_NOTES_UPDATE' | 'STUDENT_LIST_VIEW' | 'MODULE_LIST' | 'MODULE_VIEW' | 'MODULE_START' | 'MODULE_COMPLETE' | 'PROGRESS_SUBMIT' | 'PROGRESS_VIEW' | 'EXERCISE_SUBMITTED' | 'SPEAKING_EXERCISE_SUBMITTED' | 'MENTOR_SUBMISSIONS_VIEWED' | 'SUBMISSION_EVALUATED' | 'ACADEMIC_REPORT_UPLOAD' | 'ACADEMIC_REPORT_MANUAL_ENTRY' | 'GRADE_UPDATE' | 'REPORT_UPLOAD' | 'REPORT_VIEW' | 'SESSION_CREATE' | 'SESSION_UPDATE' | 'SESSION_RESCHEDULE' | 'SESSION_CANCEL' | 'MENTOR_MESSAGE_SEND' | 'MESSAGE_SEND' | 'MESSAGE_READ' | 'MESSAGE_DELETE' | 'CV_CREATE' | 'CV_UPDATE' | 'APPLICATION_CREATE' | 'APPLICATION_SUBMIT' | 'APPLICATION_UPDATE' | 'OPPORTUNITY_MATCH_VIEW' | 'OPPORTUNITY_CREATED' | 'OPPORTUNITY_UPDATED' | 'OPPORTUNITY_DELETED' | 'MODULE_CREATE' | 'MODULE_UPDATE' | 'MODULE_DELETE' | 'MODULE_STATUS_TOGGLE' | 'DIGITAL_LITERACY_LESSON_STARTED' | 'DIGITAL_LITERACY_LESSON_COMPLETED' | 'NOTIFICATION_CREATED' | 'BULK_NOTIFICATIONS_CREATED';
/**
