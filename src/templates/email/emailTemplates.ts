export const emailTemplates = {
  sessionReminder: (data: { studentName: string; sessionDate: string; location: string; mentorEmail: string }) => ({
  ...
  deadlineAlert: (data: { studentName: string; title: string; deadline: string; type: string }) => ({
  ...
  feedbackReceived: (data: { studentName: string; exerciseTitle: string; score: number; feedback: string }) => ({
  ...
  applicationUpdate: (data: { studentName: string; position: string; organization: string; status: string }) => ({
  ...
  systemAnnouncement: (data: { title: string; message: string }) => ({
  ...
  welcomeStudent: (data: { studentName: string; email: string; temporaryPassword: string }) => ({
